...
const controlStyles = {
  base: "border border-accent rounded-lg bg-transparent hover:cursor-pointer hover:bg-accent",
...
const noOptionsMessageStyles = "text-muted-foreground bg-accent";

type SelectComponentProps = {
  options:
    | OptionsOrGroups<
        { value: number | string; label: string },
        GroupBase<{ value: number | string; label: string }>
      >
    | undefined;
  createAble: boolean;
